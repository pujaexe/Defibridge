...
export function registerRadioGroup(){return registerComponent(RadioGroup, radioGroupMeta)}
...
export function registerRadio(){return registerComponent(Radio, radioMeta)}