...
export const pinInputMeta: ComponentMeta<PinInputProps>={
  ...
  export function registerPinInput(){return registerComponent(PinInput, pinInputMeta)}
...
export const pinInputFieldMeta: ComponentMeta<PinInputFieldProps>={
  ...
  export function registerPinInputField(){return registerComponent(PinInputField, pinInputFieldMeta)}
